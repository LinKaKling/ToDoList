...
todo_lists = [
    {'id': todo_list_1_id, 'name': 'Einkaufsliste', 'userid': user_id_bob},
    {'id': todo_list_2_id, 'name': 'Arbeit', 'userid': user_id_eve},
    {'id': todo_list_3_id, 'name': 'Privat', 'userid': user_id_eve},
]
entrys = [
...
@app.route('/todo-liste/<list_id>', methods=['GET', 'DELETE'])
...
@app.route('/todo-liste', methods=['POST'])
def add_new_list():
...
# define endpoint for adding new entry to list
